...
import { asyncRoutesMabu } from './mabu'
import { asyncRoutesOsport } from './osport'
 ...
 */
export const asyncRoutes: RouteConfig[] = PlatformModule.platform === PlatformModule.PLATFORM_OSPORT ? asyncRoutesOsport : asyncRoutesMabu
